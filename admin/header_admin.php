...
<body style="font-family: 'Product Sans', sans-serif; background:white;">
  ...
  <div style="background-color: #30A2FF">
    <div class="w3-bar w3-27374D"
      style="background-color: #30A2FF; font-weight: bold; margin:0 auto; width:80%;height:75px">
      <a href="mainpage.php?id=9956" class="w3-bar-item w3-button" style="width:16.66%;height:auto">
        <div class="w3-left"><i class="fas fa-home w3-xlarge"
            style="padding: 10px 0px;position:relative;right:2px;top:10px;height:60px"></i></div><br>
        MAIN PAGE
      </a>
      <div class="w3-dropdown-hover" style="width: 16.66%;">
        <button class="w3-button" style="width: 100%;">
          <div class="w3-left"><i class="fas fa-book w3-xlarge"
              style="padding: 10px 0px;;position:relative;right:-10px;top:10px;height:60px"></i></div><br>
          INFORMATION
        </button>
      ...
      <a href="analysis.php" class="w3-bar-item w3-button" style="width: 16.66%;">
        <div class="w3-left"><i class="fas fa-chart-line w3-xlarge"
            style="padding: 10px 0px;;position:relative;right:-4px;top:10px;height:60px"></i></div><br>
        MONTHLY SALES
      </a>
      ...
      <div class="w3-dropdown-hover" style="width: 16.66%;">
        <button class="w3-button" style="width: 100%;">
          <div class="w3-left"><i class="fas fa-cog w3-xlarge"
              style="padding: 10px 0px;;position:relative;right:-28px;top:10px;height:60px"></i></div><br>
          SETTING
        </button>
        <div class="w3-dropdown-content w3-bar-block w3-card-4">
      ...
      <a href='logout.php' class="w3-bar-item w3-button" style="width: 16.66%;">
        <div class="w3-left"><i class="fas fa-lock w3-xlarge"
            style="padding: 10px 0px;position:relative;right:-30px;top:10px;height:60px"></i></div><br>
        LOG OUT
      </a>
    </div>
  </div>
